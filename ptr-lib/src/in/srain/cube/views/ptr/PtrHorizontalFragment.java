...
import in.srain.cube.views.ptr.PtrFrameLayout.ScrollChecker;
...
public class PtrHorizontalFragment extends PtrFrameLayout {
	...
	public PtrHorizontalFragment(Context context) {
		this(context, null);
	}

	public PtrHorizontalFragment(Context context, AttributeSet attrs) {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (mHeaderView != null) {
			...
			MarginLayoutParams lp = (MarginLayoutParams) mHeaderView
					.getLayoutParams();
			mHeaderHeight = mHeaderView.getMeasuredWidth() + lp.leftMargin
					+ lp.rightMargin;
