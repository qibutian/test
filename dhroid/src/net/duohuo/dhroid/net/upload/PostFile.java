...
public class PostFile
{
     ...
     * @throws IOException
     */
    public String post(String actionUrl, Map<String, Object> params, FileInfo[] files)
        throws IOException
    {
        ...
        for (FileInfo file : files)
        {
            ...
            sb.append("Content-Disposition: form-data; name=\"" + file.getFileTextName() + "\"; filename=\""
     ...
     * @throws IOException
     */
    public String post(String actionUrl, Map<String, Object> params, FileInfo fileInfo)
        throws IOException
    {
