...
import net.duohuo.dhroid.reclcleadapter.RecyclerBaseAdapter.FootViewHolder;
...
public class BaseSwipeRefreshLayout extends ViewGroup {
	...
	public static int ANIMATE_TO_TRIGGER_DURATION = 200;
	private static final int ANIMATE_TO_START_DURATION = 200;
	private static final int DEFAULT_CIRCLE_TARGET = 54;
	...
	public float mTotalDragDistance = -1;
	private int mMediumAnimationDuration;
	public int mCurrentTargetOffsetTop;
	public boolean mOriginalOffsetCalculated = false;
	...
	public void animateOffsetToCorrectPosition(int from,
		...
		ANIMATE_TO_TRIGGER_DURATION = 200;
	}
	...
	private void moveToStart(float interpolatedTime) {
		...
		System.out.println("targetTop"+targetTop);
		System.out.println(" mHeadViewContainer.getTop()"+ mHeadViewContainer.getTop());
		setTargetOffsetTopAndBottom(offset, false /* requires update */);
	}
	...
	public void setLoadMoreing() {
		mFooterViewContainer.setVisibility(View.VISIBLE);
		mFooterViewContainer.bringToFront();
		mFooterViewContainer.offsetTopAndBottom(mFooterViewHeight);
	}
